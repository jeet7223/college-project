    ...
    public function actionSignup($type)
    {
        ...
        $model = new SignupForm();
            ...
            $model->scenario = SignupForm::SCENARIO_CUSTOMER;
                if ($model->load(Yii::$app->request->post()) && $model->signupCustomer()) {
        ...
        elseif ($type == "restaurant") {
            ...
            $model->scenario = SignupForm::SCENARIO_RESTAURANT;
                if ($model->load(Yii::$app->request->post()) && $model->signupRestaurant()) {
                  
                    Yii::$app->session->setFlash('success', 'Thank you for registration. We will activate your account soon');
                    return $this->goHome();

                }
                 return $this->render('signup-restaurant', [
                    'model' => $model,
                ]);
